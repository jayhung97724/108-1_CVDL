...
if __name__ == "__main__":
    ...
    w = loadUi('Q5.ui')
    w.button5_1.clicked.connect(Q5_1)
    w.button5_2.clicked.connect(Q5_2)
    w.button5_3.clicked.connect(Q5_3)
    w.button5_4.clicked.connect(Q5_4)
    w.button5_5.clicked.connect(lambda: Q5_5(int(w.lineEdit.text())))
    w.show()
    sys.exit(app.exec_())